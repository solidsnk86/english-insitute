  ...
  return pathname !== "/admin" ? (
    <button className="absolute top-4 left-4" {...props}>
      <Link
        ...
        className="flex group items-center justify-center rounded-md w-28 text-center gap-1.5 mx-auto py-1.5 bg-primary hover:bg-primary/80 transition-colors duration-300"
      >
