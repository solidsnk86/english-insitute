...
const sendWhatsApp = (num: string | number) => {
  const encoded = encodeURIComponent(
    "Buenas tardes estoy interesado en los cursos, quisiera saber como puedo inscribirme. Mi nombre es ..",
  );
...
export const WhatsAppButton = () => {
  return (
    ...
    >
      <WhatsAppIcon
        className="md:size-7 size-6 text-pascale-500 hover:text-pascale-700 transition-colors text-primary"
      />
    </div>
  );
};
